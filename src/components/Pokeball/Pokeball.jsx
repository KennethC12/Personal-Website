    ...
    <div className="pokeballs">
      ...
      <nav>
        <button className="mpokeball">
          <a href="#Project">
            <img src = "/mpokeball.png" alt="Master Ball"></img>
      ...
      <nav>
        <button className="TRpokeball">
          <a href="#Contact">
            <img src = "/TRpokeball.png" alt="Team Rocket Ball"></img>
      ...
      <button className="upokeball">
        <img src = "/upokeball.png" alt="Ultra Ball"></img>
      ...
      <nav>
        <button className="gpokeball">
          <a href="#Experience">
            <img src = "/gpokeball.png" alt="Great Ball"></img>
